...
public static void main(String[] args) throws Exception {
    ...
    String drumone="snare.jpg";
    String drumzero="snare.jpg";
    String anotherimage="cymbal.jpg";
   	 // 9. Edit the next line to use your String variable
drumLabelWithImage = createLabelImage(drumone);
...
itsadrum=createLabelImage(drumzero);
itsadrum.addMouseListener(this);
  panel.add(itsadrum);
  cymball=createLabelImage(anotherimage);
  cymball.addMouseListener(this);
  panel.add(cymball);
	 frame.pack();
    }
